...
- [ ] **Fix CV data** — `_data/cv.yml` currently contains Albert Einstein's career history as placeholder. Replace every section with actual positions, dates, and descriptions:
  - Current: Applications Physicist I at Fermilab (start year, division)
  - Postdoc history at Fermilab (2017–)
  - Education: PhD Michigan State 2017 (fill thesis title/advisor)
  - Awards & honors (any Fermilab recognition, DOE awards, etc.)
  - Grants: NeuCol SciDAC5 and any others
  - Academic interests: replace "Topic 1 / Topic 2" with actual research areas
  - Remove placeholder "other interests" filler
